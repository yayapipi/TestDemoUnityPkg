...
<root>
  ...
  ├── Editor
  │   ├── Yayapipi.Testdemo.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── Yayapipi.Testdemo.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── Yayapipi.Testdemo.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── Yayapipi.Testdemo.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `Yayapipi.Testdemo`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package TestDemo Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/Yayapipi.Testdemo.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/Yayapipi.Testdemo.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/Yayapipi.Testdemo.Editor.Tests.asmdef`

  `Tests/Runtime/Yayapipi.Testdemo.Tests.asmdef`
...
Use the `Documentations~/TestDemo.md` documentation file to create preliminary, high-level documentation. This document should introduce users to the features and sample files included in your package.  Your package documentation files will be used to generate online and local docs, available from the Package Manager UI.
